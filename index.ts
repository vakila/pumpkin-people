...
function personPositioner(person: Scene) {
  if (!person) throw new Error("cannot position a nonexistent person!");
...
const newButton = getButton("new", "new pumpkin person");
newButton.addEventListener("click", async (event) => {
  ...
  const onPointerMove = personPositioner(newPerson);
...
// Clear scene
const clearButton = getButton("clear", "clear pumpkin people");
